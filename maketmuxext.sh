...
# powerline
PLUDIRS=$(echo ${HOME}/Library/Python/{2,3}.{1..9}/lib/python/site-packages ${HOME}/.local/lib/python{2,3}.{1..9}/site-packages)
PLSDIRS=$(echo /usr/local/lib/python{2,3}.{1..9}/{site,dist}-packages)
